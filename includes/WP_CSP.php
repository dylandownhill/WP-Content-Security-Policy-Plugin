...
class WP_CSP extends WP_REST_Controller {
	...
	private static function str_rand( $largura = 32 ) {
		...
		// separar a string acima com uma virgula ap�s cada letra ou n�mero;
		...
		// se a largura for um n�mero par o numero de caracteres da string for maior ou igual a 4
	...
	public static function add_header() {
		...
		$HeaderOptions = array(
			WP_CSP::SETTINGS_OPTIONS_EXPECTCT_OPTIONS,
			WP_CSP::SETTINGS_OPTIONS_STS_OPTIONS,
			WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS,
			WP_CSP::SETTINGS_OPTIONS_XSS_PROTECTION,
			WP_CSP::SETTINGS_OPTIONS_CONTENT_TYPE_OPTIONS,
			WP_CSP::SETTINGS_OPTIONS_REFERRER_POLICY_OPTIONS,
			WP_CSP::SETTINGS_OPTIONS_EXPECTCT_MAXAGE,
			WP_CSP::SETTINGS_OPTIONS_STS_MAXAGE,
		);
	...
	public function register_routes() {
		register_rest_route(
			 WP_CSP::ROUTE_NAMESPACE , '/' . WP_CSP::ROUTE_BASE . '/LogPolicyViolation',
				array(
