	...
	<tbody data-group="Expect-CT">
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_OPTIONS ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_OPTIONS ]; ?></div><?php endif; ?>
			</td>
		</tr>
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_MAXAGE ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_MAXAGE ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_MAXAGE ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_EXPECTCT_MAXAGE ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
	...
	<tbody data-group="Strict-Transport-Security">
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_STS_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_STS_OPTIONS ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_STS_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_STS_OPTIONS ]; ?></div><?php endif; ?>
			</td>
		</tr>
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_STS_MAXAGE ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_STS_MAXAGE ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_STS_MAXAGE ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_STS_MAXAGE ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
	...
	<tbody data-group="X-Frame-Options">
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS ]; ?></div><?php endif; ?>
			</td>
		</tr>
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS_ALLOW_FROM ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS_ALLOW_FROM ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS_ALLOW_FROM ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_FRAME_OPTIONS_ALLOW_FROM ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
	...
	<tbody data-group='X-XSS-Protection'>
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_XSS_PROTECTION ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_XSS_PROTECTION ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_XSS_PROTECTION ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_XSS_PROTECTION ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
	...
	<tbody data-group='X-Content-Type-Options'>
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_CONTENT_TYPE_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_CONTENT_TYPE_OPTIONS ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_CONTENT_TYPE_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_CONTENT_TYPE_OPTIONS ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
	...
	This policy will leak origins and paths from TLS-protected resources to insecure origins. Carefully consider the impact of this setting.</li>
		...
		<tr class='wpcsp_option_row'>
			...
			<td class='wpcsp_option_cell'>
				...
				<?php
				if ( ! empty( $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_REFERRER_POLICY_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_errors'><?php echo $PolicyKeyErrors[ WP_CSP::SETTINGS_OPTIONS_REFERRER_POLICY_OPTIONS ]; ?></div><?php endif; ?>
				<?php
				if ( ! empty( $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_REFERRER_POLICY_OPTIONS ] ) ) :
?>
<div class='wpcsp_option_warnings'><?php echo $PolicyKeyWarnings[ WP_CSP::SETTINGS_OPTIONS_REFERRER_POLICY_OPTIONS ]; ?></div><?php endif; ?>
			</td>
		</tr>
	</tbody>
</table>
